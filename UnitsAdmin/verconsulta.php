...
$resultados_row = $ESObject->seeUnits($regsize, $pag, $filtro);
$numreg = $ESObject->cuentaReg( "units", $filtro );
...
if ( !$resultados_row->EOF )
{
    ...
    do
    {
		...
		if(!isset($_SESSION['permisos']['4']['2']) && !isset($_SESSION['permisos']['4']['3']) && !isset($_SESSION['permisos']['4']['4']) && $_SESSION["level"]==2)
		{
			$link = "#";
		}
		else
		{
			$link = "unitsform.php?mode=edit&unidadID=".$unidadID;
		}
...
else
{
    ...
    $texto = "No se encontraron unidades";
