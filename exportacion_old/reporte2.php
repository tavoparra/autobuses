...
// create some HTML content
  ...
  <p><img src="../imagenes/osito.jpg"/></p><br/><br/>
  <h1>REFRISERVICIO Y AIRE ACONDICIONADO PARA EL TRANSPORTE S.A. DE C.V. <br/><br/><br/><br/>
...
if ( !$mantenimientos_info->EOF )
{
	$taller_actual = "";
			...
			$html .= '<table border="0" width="90%">
					  <tr>
						<td width="10%"><img src="../imagenes/osito.jpg" width="65" height="92" /></td>
  ...
  $html .='realizados a '.$mantenimientos_info->fields['cliente'].'</span>
    ...
    do{
        $tallerid 	= $mantenimientos_info->fields["tallerid"];
			...
			if($rowcount >= 59 && !$mantenimientos_info->EOF)
			{
				$html .= '</table>
				<table width="100%" border="1" style="text-align:center; padding: 0px;">
						  <tr nobr="true">
